# Generated by Django 2.1.1 on 2018-09-22 04:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info_sensores', models.FilePathField(match='.*.json$', path='/Users/sebastiangiraldo/roya_cafe/coffee_rescuer/data', recursive=True, unique=True)),
                ('fotos', models.FilePathField(allow_files=False, allow_folders=True, match='lot.*', path='/Users/sebastiangiraldo/roya_cafe/coffee_rescuer/data', recursive=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Lote',
